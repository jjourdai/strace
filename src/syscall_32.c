...
const struct syscall syscalls_32[] = {
		...
		[__NR_sigreturn]	=	{"sigreturn", 1, {LONG, 0, 0, 0, 0, 0}, INT, -1, general},
...
*/
		...
		[__NR_uname]	=	{"uname", 0, {0, 0, 0, 0, 0, 0}, 0, 0, general},
/*
...
*/
		...
		[__NR_ugetrlimit]	=	{"ugetrlimit", 2, {INT, PTR, 0, 0, 0, 0}, INT, -1, general},
