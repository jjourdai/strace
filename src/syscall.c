...
const struct syscall syscalls[] = {
		...
		[SYS_brk]	=	{"brk", 1, {INT, 0, 0, 0, 0}, PTR, 0, general},
		...
		[SYS_kill]	=	{"kill", 2, {INT, INT, 0, 0, 0, 0}, INT, 0, general},
		...
		[SYS_tkill]	=	{"tkill", 2, {INT, INT, 0, 0, 0, 0}, INT, -1, general},
		...
		[SYS_tgkill]	=	{"tgkill", 3, {INT, INT, INT, 0, 0, 0}, INT, -1, general},
