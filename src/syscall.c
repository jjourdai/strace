...
const char *syscalls[] = {
		...
		[SYS_rt_sigreturn]	=	"rt_sigreturn/ptregs",
		[SYS_ioctl]	=	"ioctl",
		[SYS_pread64]	=	"pread64",
		...
		[SYS_clone]	=	"clone/ptregs",
		[SYS_fork]	=	"fork/ptregs",
		[SYS_vfork]	=	"vfork/ptregs",
		[SYS_execve]	=	"execve/ptregs",
		[SYS_exit]	=	"exit",
		[SYS_wait4]	=	"wait4",
		[SYS_kill]	=	"kill",
		[SYS_uname]	=	"newuname",
